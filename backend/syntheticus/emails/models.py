...
from .content import write_password_reset_email, write_registration_email
...
EMAIL_SUBJECTS = {
    EMAIL_TYPES['UserRegistration']: 'User Registration',
    EMAIL_TYPES['PasswordReset']: 'Password Reset',
}
